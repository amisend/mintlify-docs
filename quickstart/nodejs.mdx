...
Amisend is internal: access is granted by the team, there is no public sign-up.
Sign in at [amisend](https://www.amisend.com/login) and create an **API Key** from
the dashboard. The key is scoped to the team it was created in.
